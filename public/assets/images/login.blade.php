...
<body style="background-color:#ECECEC;margin-top:5px;">
    <p><map name="FPMap0">
            ...
            <area href="login.php" shape="rect" coords="677, 96, 798, 124">
...
<span class="red">*</span>Last Updated :26 Aug 2016
                        ...
                        <td class="contentArea">
                            <form action="{{ route('login') }}" method="post" enctype="multipart/form-data" id="acclogin">
                                <h2 align="center"><strong>Login Step 1:</strong> Log in to Access your Account</h2>
                                <p align="center">Enter Your Account Login Details to proceed</p>
                                                ...
                                                <tr class="text">
                                                    ...
                                                    <td>
                                                        <span id="sprytextfield1" style="text-align:left;">
                                                            ...
                                                            <br />
                                                            <span class="textfieldRequiredMsg">Account Number is
                                                                required.</span>
                                                            <span class="textfieldInvalidFormatMsg">Invalid Account
                                                                Number.</span>
                                                        </span>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <span id="sprypassword1" style="text-align:left;">
                                                            <input name="pass" type="password" id="pass"
                                                                tabindex="20" size="30" /><br />
                                                            <span class="passwordRequiredMsg">Password is
                                                                required.</span>
                                                            <span class="passwordMinCharsMsg">You must specify at least
                                                                6 characters.</span>
                                                            <span class="passwordMaxCharsMsg">You must specify at max
                                                                10 characters.</span>
                                                        </span>
                                                    </td>
                                                </tr>
...
If your account is not register with us, please <a href="#">Register it Now</a>.
        ...
        <tr>
            <td align="center">&nbsp;&nbsp; <span class="sub_Header">
                ...
                <img border="0" src="{{ asset('images/eca-logo.png') }}" width="90" height="65"> <span class="sub_content">
                    <img border="0" src="{{ asset('images/128bit.png') }}" width="180" height="90"></span>
            </td>
        </tr>
