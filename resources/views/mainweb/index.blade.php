...
<body>
    ...
    <header class="header navbar-area">
        <!-- Toolbar Start -->
        <div class="toolbar-area bg-dark">
            <div class="container">
                <div class="row">
                ...
                <div class="nav-inner">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="index.html">
                            <img src="storage/images/rbc-logo-shield.svg" alt="Logo">
                        </a>
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a class="page-scroll active" href="javascript:void(0)">Accounts</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="javascript:void(0)">Credit Cards</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="javascript:void(0)">Mortgages</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="javascript:void(0)">Loans</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="javascript:void(0)">Investments</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="javascript:void(0)">Rewards</a>
                                </li>
                            </ul>
                        </div> <!-- navbar collapse -->
                        <div class="button">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="home-slider">
                            <div class="hero-text">
                                <img src="storage/images/front/rbc-vantage-blue-en.svg" class="img-responsive">
                                <p class="wow fadeInUp" data-wow-delay=".7s">Unlock rewards, savings, insights and more every day with any eligible bank account. Only at RBC.</p>
                                <div class="button wow fadeInUp" data-wow-delay=".9s">
                                    <a href="/about-us.html" class="btn mouse-dir">Explore RBC Banking<span
